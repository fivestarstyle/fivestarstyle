...
public class ConfirmLabelsNoColor extends AppCompatActivity {
        ...
        right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(catFlag == 1) {
                    ...
                    Toast.makeText(ConfirmLabelsNoColor.this, "Please select one category.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        createTabs();
        ...
        right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(seasonFlag >= 1) {
                    ...
                    Toast.makeText(ConfirmLabelsNoColor.this, "Please select at least one season.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(eventFlag == 1) {
                    ...
                    Toast.makeText(ConfirmLabelsNoColor.this, "Please select at least one event.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        left.setVisibility(View.VISIBLE);
    ...
    public void showPopup(View v) {
        ...
        btnRestart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent restartIntent = new Intent(ConfirmLabelsNoColor.this, ConfirmLabelsAll.class);
