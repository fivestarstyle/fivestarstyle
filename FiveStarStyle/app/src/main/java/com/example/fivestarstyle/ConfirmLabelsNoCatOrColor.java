...
public class ConfirmLabelsNoCatOrColor extends AppCompatActivity {
        ...
        right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(seasonFlag >= 1) {
                    ...
                    Toast.makeText(ConfirmLabelsNoCatOrColor.this, "Please select at least one season.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        createTabs();
        ...
        right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(eventFlag >= 1) {
                    ...
                    Toast.makeText(ConfirmLabelsNoCatOrColor.this, "Please select at least one event.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void showPopup(View v) {
        ...
        btnRestart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent restartIntent = new Intent(ConfirmLabelsNoCatOrColor.this, ConfirmLabelsAll.class);
